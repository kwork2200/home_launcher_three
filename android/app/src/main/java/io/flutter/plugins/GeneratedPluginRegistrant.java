...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.wallpaper_handler.WallpaperHandlerPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin wallpaper_handler, com.example.wallpaper_handler.WallpaperHandlerPlugin", e);
    }
    try {
